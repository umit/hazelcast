...
public class CreateSemaphoreMessageTask extends AbstractMessageTask implements ExecutionCallback {
    ...
    CreateSemaphoreMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
        super(clientMessage, node, connection);
    }

    @Override
    protected void processMessage() {
        RaftSemaphoreService service = nodeEngine.getService(getServiceName());
