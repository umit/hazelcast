...
public class GetLockCountMessageTask extends AbstractLockMessageTask {
    ...
    GetLockCountMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
    ...
    protected void processMessage() {
        ...
        invocationManager.invoke(groupId, new GetLockCountOp(name, sessionId, threadId)).andThen(this);
    }
