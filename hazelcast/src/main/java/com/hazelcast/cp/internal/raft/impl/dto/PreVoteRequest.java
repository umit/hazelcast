...
public class PreVoteRequest implements IdentifiedDataSerializable {
    ...
    private EndpointIdentifier candidate;
    ...
    public PreVoteRequest(EndpointIdentifier candidate, int nextTerm, int lastLogTerm, long lastLogIndex) {
    ...
    public EndpointIdentifier candidate() {
        return candidate;
    }
