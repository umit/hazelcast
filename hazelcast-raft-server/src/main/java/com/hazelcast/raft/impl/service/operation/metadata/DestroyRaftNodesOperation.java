...
public class DestroyRaftNodesOperation extends Operation implements IdentifiedDataSerializable, AllowedDuringPassiveState {

    private Collection<RaftGroupId> groupIds;

    public DestroyRaftNodesOperation() {
    }

    public DestroyRaftNodesOperation(Collection<RaftGroupId> groupIds) {
