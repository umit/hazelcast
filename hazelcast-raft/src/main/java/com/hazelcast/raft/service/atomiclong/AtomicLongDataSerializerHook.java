...
public final class AtomicLongDataSerializerHook implements DataSerializerHook {
    ...
    private static final int RAFT_ATOMICLONG_DS_FACTORY_ID = -1011;
    private static final String RAFT_ATOMICLONG_DS_FACTORY = "hazelcast.serialization.ds.raft.atomiclong";

    public static final int F_ID = FactoryIdHelper.getFactoryId(RAFT_ATOMICLONG_DS_FACTORY, RAFT_ATOMICLONG_DS_FACTORY_ID);
